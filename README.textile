...
Every 'Key' will be validated with 'Spotlight' if the value is missing. If you remove a default path, the script search for the latest Version on your local maschine.
